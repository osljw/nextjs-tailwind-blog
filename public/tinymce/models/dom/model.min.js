...
!(function () {
  ...
  const ps = (e, t, o, n) => {
    ...
    Dl = (e, t) =>
      Tl(e, t, x).map((e) => ({ cells: e, generators: t.generators, clipboard: t.clipboard })),
    Ol = (e, t) => Tl(e, t, x),
    ...
    Ql = (e, t, o, n, r) => {
      const s = qo(e).rows,
        l = j(t, (e) => Jl(s, e, n)),
        a = E(s, (e) => nl(e.cells)),
        c = ((e, t) => (P(t, h) && nl(e) ? x : (e, o, n) => !('th' === ne(e.element) && t[o])))(
          l,
          a
        ),
        i = (
    ...
    Ta = (e, t) => (o, n, r, s, l) => {
      const a = Sa(n),
        ...
        i = ((e, t, o, n, r, s, l) => {
          ...
          const f = [...a, ...u],
            g = ((e, t) =>
              P(t, h) && nl(e.cells) ? x : (e, o, n) => !('th' === ne(e.element) && t[n]))(i, d),
            p = (
              (e, t) => (o, n, r) =>
    ...
    Za = Rl(
      ...
      (e, t) =>
        qt(t.element).bind((o) =>
          Sl(e, o).map((e) => ({ ...e, generators: t.generators, clipboard: t.clipboard }))
        ),
      Ea,
      f,
      da
          ...
          (i, m, d = !1) => {
            ...
            return s(i)
              ? n(i, m, f, g).bind((n) => {
                  ...
                  return (
                    lt(i) && (ts(i), d || ic(e, i.dom, c)), r.map((e) => ({ rng: e, effect: c }))
                  )
                })
              : C.none()
          },
    ...
    vc = {
      ...wc,
      from: (e) =>
        Rt(e, '%') ? bc('%', wc.percent, e) : Rt(e, 'px') ? bc('px', wc.pixels, e) : wc.invalid(e),
    },
    yc = (e, t, o) => {
      const n = vc.from(o),
        r = P(e, (e) => '0px' === e)
          ...
          o().each((o) => {
            ...
            l((o, r) => {
              const s = _r(xe.fromDom(e.getDoc())),
                l = ((e, t, o, n) => ({ selection: Os(e), clipboard: o, generators: n }))(
                  Ps(e),
                  0,
                  n,
                  s
  ...
  const ui = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
      ...
      bt(n, 'td,th', t).bind((n) =>
        bt(n, 'table', t).bind((s) =>
          ((e, t) => ft(e, (e) => Ne(e).exists((e) => Re(e, t)), void 0).isSome())(r, s)
            ? ((e, t, o) =>
                Yi(e, t, o).bind((n) => Ji(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(
                e,
                t,
                o
              ).bind((e) =>
    ...
    Om = (e) => {
      if (e.rangeCount > 0) {
        ...
        return C.some(
          ui(xe.fromDom(t.startContainer), t.startOffset, xe.fromDom(o.endContainer), o.endOffset)
        )
      }
      return C.none()
    },
