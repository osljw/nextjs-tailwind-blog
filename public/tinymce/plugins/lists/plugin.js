...
;(function () {
          ...
          const parsedSiblings = foldl(
            ...
            (acc, s, i) => {
              if (i === 0) {
                ...
                const parsedSibling = parseSingleItem(depth, itemSelection, selectionState, s).map(
                  (e) => entryToEntryNoList(e, s.dom.nodeName.toLowerCase(), true)
                )
  ...
  const isValidLists = (list1, list2) => {
    return (
      isListNode(list1) &&
      list1.nodeName === (list2 === null || list2 === void 0 ? void 0 : list2.nodeName)
    )
  }
  ...
  const toggleMultipleLists = (editor, parentList, lists, listName, detail) => {
    ...
    if (
      ...
      const updateFunction =
        parentIsList && isCustomList(parentList) ? updateCustomList : updateList$1
