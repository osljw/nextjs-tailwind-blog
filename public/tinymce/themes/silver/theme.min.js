...
!(function () {
  ...
  const an = (e, t, o) => (e.stype === rn.Error ? t(e.serror) : o(e.svalue)),
        ...
        case 'required':
          return ((e, t, o, n) =>
            be(t, o).fold(
              () =>
                ((e, t, o) =>
                  kn(e, () => 'Could not find valid *required* value for "' + t + '" in ' + Sn(o)))(
                  e,
                  o,
                  t
                ),
      ...
      return {
        extract: (e, n) => {
          ...
          return 0 === r.length
            ? t.extract(e, n)
            : ((e, t) =>
                kn(e, () => 'There are unsupported fields: [' + t.join(', ') + '] specified'))(e, r)
        },
        toString: t.toString,
      }
    },
    ...
    Wn = Cn((e) =>
      Un(e) ? dn(e) : un('Expected value to be acceptable for sending via postMessage')
    ),
    jn = (e, t) => ({
      extract: (o, n) =>
        be(n, e).fold(
              ...
              be(o, n).fold(
                () =>
                  ((e, t, o) =>
                    kn(
                      e,
                      () => 'The chosen schema: "' + o + '" did not exist in branches: ' + Sn(t)
                    ))(e, o, n),
    ...
    qn = (e, t, o) => {
      return (
        (n = ((e, t, o) =>
          ((e, t) => (e.stype === rn.Error ? { stype: rn.Error, serror: t(e.serror) } : e))(
            t.extract([e], o),
            (e) => ({ input: o, errors: e })
          ))(e, t, o)),
    ...
    ts = (e) =>
      Gn((t) =>
        R(e, t)
          ? sn.value(t)
          : sn.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)
      ),
      ...
      Ur(e, (e, o) => {
        const n = o.event,
          s = e
            ...
            .getByDom(n.target)
            .getOrThunk(() =>
              Is(n.target, (t) => e.getSystem().getByDom(t).toOptional(), T).getOr(e)
            )
        t(e, s, o)
      }),
    qr = (e) =>
  ...
  const la = (e) => {
    ...
    wa = la('alloy-premade'),
    Sa = (e) => (
      Object.defineProperty(e.element.dom, wa, { value: e.uid, writable: !0 }), Ms(wa, e)
    ),
    ka = (e) => be(e, wa),
    Ca = (e) =>
      ((e, t) => {
        const o = t.toString(),
          ...
          r = o.substring(s + 1, n - 1).split(/,\s*/)
        return (
          (e.toFunctionAnnotation = () => ({ name: 'OVERRIDE', parameters: ya(r.slice(1)) })), e
        )
    ...
    Fa = (e, t) =>
      ((e, t) => {
        ...
        return o.errors.length > 0
          ...
          : ((e, t) => (0 === e.length ? sn.value(t) : sn.value(fn(t, bn.apply(void 0, e)))))(
              o.values,
              t
            )
        var n
  ...
  const _i = x(Dn(Oi())),
    ...
    sl = (e, t, o) =>
      zi(Zi(e), ol(e), o.southeast(), Li(), 'southeast', Ki(e, { left: 1, top: 3 }), Ji),
    rl = (e, t, o) =>
      zi(el(e, t), ol(e), o.southwest(), Pi(), 'southwest', Ki(e, { right: 0, top: 3 }), Ji),
    al = (e, t, o) =>
      zi(Zi(e), tl(e, t), o.northeast(), Ui(), 'northeast', Ki(e, { left: 1, bottom: 2 }), Ji),
    il = (e, t, o) =>
      zi(el(e, t), tl(e, t), o.northwest(), Wi(), 'northwest', Ki(e, { right: 0, bottom: 2 }), Ji),
    ll = (e, t, o) => zi(Qi(e, t), tl(e, t), o.north(), Gi(), 'north', Ki(e, { bottom: 2 }), Ji),
    cl = (e, t, o) => zi(Qi(e, t), ol(e), o.south(), ji(), 'south', Ki(e, { top: 3 }), Ji),
    dl = (e, t, o) =>
      zi(((e) => e.x + e.width)(e), nl(e, t), o.east(), $i(), 'east', Ki(e, { left: 0 }), Ji),
    ul = (e, t, o) =>
      zi(
        ((e, t) => e.x - t.width)(e, t),
        nl(e, t),
    ...
    Sl = (e, t, o, n, s, r, a) => {
      const i = (e) => (ye(e, o) ? e[o]() : A.none()),
        ...
        c = {
          ...
          schema: x(t),
          exhibit: (e, t) =>
            Se(i(e), be(n, 'exhibit'), (e, o) => o(t, e.config, e.state)).getOrThunk(() => Ea({})),
          name: x(o),
          handlers: (e) =>
            i(e)
  ...
  var kc = [
      ...
      Ri('placement', (e, t, o) => {
        ...
        return A.some(
          hc({ anchorBox: s, bubble: t.bubble.getOr(pc()), overrides: t.overrides, layouts: r })
        )
      }),
    ],
    Cc = [
        ...
        return ((e, t) => {
          ...
          return o.collapsed
            ? t
                ...
                .map((e) =>
                  jc.rtl(Ve(e.endContainer), e.endOffset, Ve(e.startContainer), e.startOffset)
                )
  ...
  var nd = [
    ...
    Ri('placement', (e, t, o) => {
      const n = nt(t.root).dom,
        ...
        a = od(n, t)
          .bind((e) =>
            td(e) ? (Ge(e.start) ? A.some(e.start) : rt(e.start)) : A.some(e.firstCell)
          )
          .getOr(e.element)
      return Ic(r, s, t, o, a)
    }),
  ...
  const sd = 'link-layout',
    ...
    ld = (e) => e.y,
    cd = (e, t, o) =>
      zi(rd(e), ld(e), o.southeast(), Li(), 'southeast', Ki(e, { left: 0, top: 2 }), sd),
    dd = (e, t, o) =>
      zi(ad(e, t), ld(e), o.southwest(), Pi(), 'southwest', Ki(e, { right: 1, top: 2 }), sd),
    ud = (e, t, o) =>
      zi(rd(e), id(e, t), o.northeast(), Ui(), 'northeast', Ki(e, { left: 0, bottom: 3 }), sd),
    md = (e, t, o) =>
      zi(ad(e, t), id(e, t), o.northwest(), Wi(), 'northwest', Ki(e, { right: 1, bottom: 3 }), sd),
    gd = () => [cd, dd, ud, md],
    pd = () => [dd, cd, md, ud]
  var hd = [
      os('item'),
  ...
  const Sd = Ol({
    ...
    Wd = (e, t, o) => {
      ;((e) => N(['top', 'left', 'right', 'bottom'], (t) => Nt(e, t).isSome()))(e.element) ||
  ...
  var du = [
    ...
    gu = [
      xs('store', { mode: 'memory' }, Jn('mode', { memory: mu, manual: uu, dataset: du })),
      Di('onSetValue'),
      ys('resetOnDom', !1),
    ]
  const pu = Ol({
  ...
  const Xu = (e, t, o, n) =>
      fn(t.defaults(e, o, n), o, { uid: e.partUids[t.name] }, t.overrides(e, o, n)),
    Yu = (e, t) => {
      const o = {}
      return (
        L(t, (t) => {
            ...
            e.fold(
              ...
              (e) => {
                n[e.pname] = Ou(!0, (t, o, n) => {
                  const s = t[e.name]
                  return H(s, (o) =>
                    e.factory.sketch(fn(e.defaults(t, o, n), o, e.overrides(t, o)))
                  )
                })
              }
            )
  ...
  const Rm = Ol({ fields: Im, name: 'disabling', active: Fm, apis: Bm }),
    ...
    Vm = (e, t, o, n) => {
      Nm(e, t, 0, [n]),
        zm(e, t, o, n) || (La(n.element, t.highlightClass), t.onHighlight(e, n), Fr(n, Dr()))
    },
    zm = (e, t, o, n) => Ua(n.element, t.highlightClass),
    Hm = (e, t, o) =>
      pi(e.element, '.' + t.itemClass).bind((t) => e.getSystem().getByDom(t).toOptional()),
    Lm = (e, t, o) => {
  ...
  var Wm = Object.freeze({
      ...
      getHighlighted: (e, t, o) =>
        pi(e.element, '.' + t.highlightClass).bind((t) => e.getSystem().getByDom(t).toOptional()),
      getFirst: Hm,
      getLast: Lm,
  ...
  var bg = fg(es('cyclic', T)),
    vg = fg(es('cyclic', E))
  const yg = (e, t, o) =>
      vm(o) && rg(Km)(t.event) ? A.none() : ((e, t, o) => (Nr(e, o, ur()), A.some(!0)))(e, 0, o),
    xg = (e, t) => A.some(!0),
    wg = [
      ys('execute', yg),
      ys('useSpace', !1),
  ...
  const _g = (e) => (t, o, n, s) => {
    ...
    Xg = x([
      ...
      dg(rg(Km.concat(Xm)), (e, t, o, n) =>
        ((e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)))(e, o).bind((n) =>
          o.execute(e, t, n)
        )
      ),
    ]),
  ...
  const Kp = Ol({ fields: [Cs('reuseDom', !0)], name: 'replacing', apis: Yp }),
    Jp = (e, t) => {
      ...
      return {
        key: e,
        value: { config: {}, me: o, configAsRaw: x({}), initialConfig: {}, state: Oa },
      }
    },
    Zp = (e, t) => {
  ...
  const uh = () => {
    ...
    kh = [
      os('dom'),
      os('components'),
      Ri('builder', (e) => ({ dom: e.dom, components: e.components, events: Hr([Xr(mr())]) })),
    ],
    Ch = x('item-widget'),
    Oh = x([
      Uu({
        ...
        overrides: (e) => ({
          behaviours: kl([
            pu.config({ store: { mode: 'manual', getValue: (t) => e.data, setValue: b } }),
          ]),
        }),
      }),
    ]),
          ...
          y = {
            ...
            repositionMenus: (t) => {
              ...
              o.fold(
                () => {
                  ;((e) =>
                    A.from(e.components()[0]).filter((e) => 'menu' === Ot(e.element, 'role')))(
                    t
                  ).each((o) => {
      ...
      factory: (e, t) => {
        ...
        return {
          ...
          behaviours: bu(e.inlineBehaviours, [
            Xd.config({
              isPartOf: (t, o, n) =>
                vi(o, n) || ((t, o) => e.getRelated(t).exists((e) => vi(e, o)))(t, n),
  ...
  var Cf = of([
    ...
    jf = (function e() {
      ...
      var w = (function (e, t) {
          if ('object' !== $h(e) || 'function' != typeof e.createPolicy) return null
          var o = null,
      ...
      var D,
        ...
        Se = function (e) {
          ;(ye && ye === e) ||
            ...
            e.FORBID_CONTENTS && (ie === le && (ie = Sf(ie)), wf(ie, e.FORBID_CONTENTS)),
            se && (L['#text'] = !0),
      ...
      var Ee = function (e) {
        ...
        Ie = function (e) {
          ...
          if (!L[s] || G[s]) {
            if (!G[s] && Ne(s)) {
              if (j.tagNameCheck instanceof RegExp && vf(j.tagNameCheck, s)) return !1
          ...
          return e instanceof l &&
            ...
            ? (Ee(e), !0)
            : ('noscript' !== s && 'noembed' !== s) || !vf(/<\/no(script|embed)/i, e.innerHTML)
            ? (K &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = hf(t, F, ' ')),
        ...
        Re = function (e, t, o) {
          ...
          if (X && !$[t] && vf(R, t));
            ...
            if (
              !(
                (Ne(e) &&
                  ((j.tagNameCheck instanceof RegExp && vf(j.tagNameCheck, e)) ||
                    (j.tagNameCheck instanceof Function && j.tagNameCheck(e))) &&
                  ((j.attributeNameCheck instanceof RegExp && vf(j.attributeNameCheck, t)) ||
                    (j.attributeNameCheck instanceof Function && j.attributeNameCheck(t)))) ||
                ('is' === t &&
                  j.allowCustomizedBuiltInElements &&
                  ((j.tagNameCheck instanceof RegExp && vf(j.tagNameCheck, o)) ||
      ...
      return (
        (o.sanitize = function (e, s) {
          ...
          if (((be = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !Be(e))) {
            if ('function' != typeof e.toString) throw yf('toString is not a function')
            if ('string' != typeof (e = e.toString())) throw yf('dirty is not a string, aborting')
          }
          if (!o.isSupported) {
          ...
          if ((Z || Se(s), (o.removed = []), 'string' == typeof e && (re = !1), re)) {
            if (e.nodeName) {
              var m = B(e.nodeName)
              if (!L[m] || G[m]) throw yf('root node is forbidden and cannot be sanitized in-place')
            }
          } else if (e instanceof i)
            (1 === (l = (a = Me('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType &&
              'BODY' === l.nodeName) ||
            'HTML' === l.nodeName
              ? (a = l)
              : a.appendChild(l)
      ...
      factory: (e) => {
        const t = Gh({
          ...
          l = ((e, t, o) => {
            const n = o(),
              s = G(e, (e) => ve(n, Kf(e, n)))
            return eb({ tag: 'div', classes: ['tox-notification__icon'] }, s.getOr(Xf), n, A.none())
          })(a, 0, e.iconProvider),
          c = [
            l,
            {
  ...
  const cb = (e) => (t) => t.options.get(e),
    ...
    ub = (e) => {
      ...
      n('skin', { processor: (e) => r(e) || !1 === e, default: 'oxide' }),
        ...
        n('width', { processor: a, default: ab.DOM.getStyle(e.getElement(), 'width') }),
        ...
        n('resize', { processor: (e) => 'both' === e || d(e), default: !lb.deviceType.isTouch() }),
  ...
  const hv = 'tox-menu-nav__js',
    ...
    Bv = (e, t, o) => {
      const n = Ev(o)
      return { dom: { tag: 'div', classes: q([[n.tieredMenu]]) }, markers: Av(o) }
    },
    Fv = x([
      us('data'),
      ys('inputAttributes', {}),
    ...
    Qv = (e, t, o, n, s) => {
      const r =
        ((a = o),
        {
          ...
          components: [
            Dh.parts.items({ preprocess: (e) => Xv(e, (e, t) => 'separator' === a[t].type) }),
          ],
        })
      var a
    ...
    ey = (e, t, o, n, s) => {
          ...
          components: [
            {
              ...
              components: [
                Dh.parts.items({
                  preprocess:
                    'auto' !== e ? qv({ tag: 'div', classes: ['tox-swatches__row'] }, e) : w,
                }),
              ],
            },
          ],
      ...
      if ('listpreview' === s.menuType && 'auto' !== n) {
        const t = ((e) => ({
          ...
          components: [
            Dh.parts.items({
              preprocess: qv({ tag: 'div', classes: ['tox-collection__group'] }, e),
            }),
          ],
        }))(n)
        return { value: e, dom: t.dom, components: t.components, items: o }
    ...
    Wy = Dn(
      [
        ...
        by,
        ds('commands', Uy),
        ms('launch', Jn('type', { contextformbutton: Ly, contextformtogglebutton: Py })),
      ].concat(Vy)
    ),
    ...
    Xy = Dn(qy),
    Yy = En(() => jn('type', { cardimage: $y, cardtext: Xy, cardcontainer: Ky })),
    Ky = Dn([
      ty,
  ...
  const bx = Ol({ fields: hx, name: 'tooltipping', active: px, state: fx, apis: gx }),
    vx = 'silver.readonly',
  ...
  const xx = (e, t) => {
    ...
    Ox = (e) => Rm.config({ disabled: e, disableClass: 'tox-tbtn--disabled', useNative: !1 }),
    _x = (e, t) => {
      const o = e.getApi(t)
      return (e) => {
        e(o)
    ...
    Mx = { [ur()]: ['disabling', 'alloy.base.behaviour', 'toggling', 'item-events'] },
    Dx = we,
    Bx = (e, t, o, n) => {
      const s = Es(b)
      return {
    ...
    Fx = (e) => ({ value: e.value, meta: { text: e.text.getOr(''), ...e.meta } }),
    Ix = (e) => {
    ...
    Nx = (e) => ({ dom: { tag: 'div', classes: [wv] }, components: [ti($f.translate(e))] }),
    Vx = (e, t) => ({ dom: { tag: 'div', classes: t, innerHtml: e } }),
    zx = (e, t) => ({
      dom: { tag: 'div', classes: [wv] },
      components: [{ dom: { tag: e.tag, styles: e.styles }, components: [ti($f.translate(t))] }],
    }),
    Hx = (e) => ({
    ...
    Px = (e) => {
      const t = e
        .map((e) => ({ attributes: { title: $f.translate(e), id: la('menu-item') } }))
        .getOr({})
      ...
      'color' === e.presets
        ...
        : ((e, t, o, n) => {
            const s = { tag: 'div', classes: [xv] },
              r = o
                ? e.iconContent.map((e) => tb(e, s, t.icons, n)).orThunk(() => A.some({ dom: s }))
                : A.none(),
              a = e.checkMark,
    ...
    iw = (e) => {
      ...
      return (
        (t = ow(255 * (t + d))), (o = ow(255 * (o + d))), (n = ow(255 * (n + d))), rw(t, o, n, 1)
      )
    },
    lw = (e) => {
      const t = ((e) => {
    ...
    hw = (e, t) => e.dispatch('ResolveName', { name: t.nodeName.toLowerCase(), target: t }),
    fw = (e, t) => () => {
      e(), t()
    },
    bw = (e) =>
  ...
  const kw = {},
    ...
    Gw = (e, t, o) =>
      e.concat(
        ((e) =>
          H(Cw(e).state(), (e) => ({ type: 'choiceitem', text: e, icon: 'checkmark', value: e })))(
          t
        ).concat(Ww(o))
      ),
    $w = (e, t, o) => (n) => {
              ...
              behaviours: kl([
                Jp('insert-table-picker', [
                  ...
                  $r(tS, (e, t, o) => {
                    ...
                    ;((e, t, o, n, s) => {
                      for (let n = 0; n < 10; n++)
                        for (let s = 0; s < 10; s++) dh.set(e[n][s], n <= t && s <= o)
                    })(n, s, a),
      ...
      colorswatch: (e, t) => {
        const o = ((e, t) => {
            ...
            return e.initData.colors.fold(
              () => Gw(t.colorinput.getColors(e.initData.storageKey), e.initData.storageKey, o),
              (e) => e.concat(Ww(o))
            )
          })(e, t),
    ...
    _S = (e, t, o) => {
      ...
      return {
        ...
        behaviours: yu(e.sandboxBehaviours, [
          ...
          Al.config({ channels: { ...Qd({ isExtraPart: T }), ...tu({ doReposition: OS }) } }),
        ]),
      }
    },
    TS = (e) => {
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          behaviours: bu(e.dropdownBehaviours, [
            ...
            uS.config({
              others: {
                sandbox: (t) => _S(e, t, { onOpen: () => dh.on(t), onClose: () => dh.off(t) }),
              },
            }),
            Pp.config({
              mode: 'special',
              ...
              onEscape: (e, t) => (DS.isOpen(e) ? (DS.close(e), A.some(!0)) : A.none()),
            }),
            oh.config({}),
          ]),
          events: mh(
  ...
  const NS = (e, t, o, n, s) => {
            ...
            A.some(
              ((e, t, o, n = !0) => {
                ...
                return fn(
                  ...
                  { toggling: { toggleClass: yv, toggleOnExecute: !1, selected: e.active } }
                )
              })(a(e), t, r, n)
            )
          )
    ...
    VS = (e, t, o, n, s, r, a) => {
      ...
      return we(
        H(e, (e) => {
          switch (e.type) {
            case 'separator':
              return ((n = e), qn('Autocompleter.Separator', Ay, n)).fold(Zv, (e) => A.some(iS(e)))
            case 'cardmenuitem':
              return ((e) => qn('cardmenuitem', Zy, e))(e).fold(Zv, (e) =>
                A.some(
                  ((e, t, o, n) => {
                    ...
                    s,
                    r,
                    { itemBehaviours: Wx(e.meta, r), cardText: { matchText: t, highlightOn: a } }
                  )
                )
              )
            default:
    ...
    LS = (e, t) => {
                  ...
                  Ph.showMenuAt(
                    ...
                    ((e, t, o, n) => {
                      ...
                      return {
                        ...
                        menu: { markers: Av(n), fakeFocus: o === RS.ContentFocus },
                      }
                    })(
                      ey('autocompleter-value', !0, o, r, { menuType: 'normal' }),
                      r,
                      RS.ContentFocus,
                      'normal'
                    )
      ...
      ;((e, t) => {
        ...
        { cancelIfNecessary: c, isMenuOpen: r, isActive: a, isProcessingAction: o.get, getMenu: l },
        e
      )
    },
          ...
          return (
            ...
            i.isStopped()
              ...
              : st(e.element).fold(
                  ...
                  (n) => (r.logEventResponse(t, e.element, o.purpose), JS.resume(n))
                )
          )
        }
      )
    ...
    nk = (e) => {
      const t = (t) => st(e.element).fold(E, (e) => Ze(t, e)),
        ...
        s = YS(e.element, {
          triggerEvent: (e, t) =>
            Si(e, t.target, (o) => ((e, t, o, n) => ek(e, t, o, o.target, n))(n, e, t, o)),
        }),
        r = {
          debugInfo: x('real'),
          triggerEvent: (e, t, o) => {
        ...
        p = (e) =>
          o
            ...
            .fold(
              () =>
                sn.error(new Error('Could not find component with uid: "' + e + '" in system.')),
              sn.value
            ),
        h = (e) => {
  ...
  var ik = Object.freeze({
      __proto__: null,
      exhibit: (e, t) => Ea({ attributes: Ds([{ key: t.tabAttr, value: 'true' }]) }),
    }),
  ...
  const fO = bm({
    ...
    CO = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = []
            return { field: (t, o) => (e.push(t), Ju(xO, SO(t), o)), record: x(e) }
          })(),
          o = e(t),
          n = t.record(),
        ...
        c = fm({
          factory: () => {
            const s = {
              ...
              g = (e, t) => {
                ...
                ;((e) => 'hex' === e.type)(n)
                  ...
                  : ((e, t, o) => {
                      ...
                      d(t, A.some(n)),
                        c('red')
                          .bind((e) => c('green').bind((t) => c('blue').map((o) => rw(e, t, o, 1))))
                          .each((t) => {
                            const o = ((e, t) => {
                              const o = Qx(t)
                              return (
              ...
              p = (t) => ({ label: e(EO + t + '.label'), description: e(EO + t + '.description') }),
              h = p('red'),
              f = p('green'),
              b = p('blue'),
              v = p('hex')
            return fn(
              CO.sketch((o) => ({
                ...
                components: [
                  o.field('red', ak.sketch(r(aw, 'red', h.label, h.description, 255))),
                  o.field('green', ak.sketch(r(aw, 'green', f.label, f.description, 255))),
                  o.field('blue', ak.sketch(r(aw, 'blue', b.label, b.description, 255))),
                  o.field('hex', ak.sketch(r(Kx, 'hex', v.label, v.description, 'ffffff'))),
                  i.asSpec(),
                ],
                formBehaviours: kl([
  ...
  const PO = (e, t) => {
    ...
    p_ = (e, t, o) =>
      tb(e, { tag: 'span', classes: ['tox-icon', 'tox-tbtn__icon-wrap'], behaviours: o }, t),
    h_ = (e, t) => p_(e, t, []),
    ...
    x_ = (e, t, o) => {
      const n = Es(b),
        ...
        a = (e, t) => {
          ...
          return oh.focus(o), Ir(o, 'keydown', { raw: t.event.raw }), DS.close(o), A.some(!0)
        },
        i = e.role.fold(
          () => ({}),
          (e) => ({ role: e })
          ...
          DS.sketch({
            ...
            sandboxBehaviours: kl([
              ...
              Jp('dropdown-sandbox-events', [
                ...
                Ur(Hv, (e, t) => {
                  ;((e, t) => {
                    ;((e) => Xd.getState(e).bind(Gm.getHighlighted).bind(Gm.getHighlighted))(
                      e
                    ).each((o) => {
                      ;((e, t, o, n) => {
                        const s = { ...n, target: t }
    ...
    T_ = (e, t, o, n) =>
      H(o, (o) =>
        O_(o)
          ...
          : { type: 'nestedmenuitem', text: o.text, getSubmenuItems: () => T_(e, t, o.items, n) }
      ),
    ...
    W_ = (e, t) => {
      Pa(e.element, t.closedClass), La(e.element, t.openClass), Ht(e.element, H_(t))
    },
    j_ = (e, t, o, n) => {
      o.setCollapsed(),
    ...
    G_ = (e, t, o, n) => {
      ...
      const r = z_(e, t)
      Pa(r, t.growingClass), La(r, t.shrinkingClass), U_(e, t), t.onStartShrink(e)
    },
    $_ = (e, t, o) => {
      ...
      exhibit: (e, t, o) => {
        ...
        return Ea(
          n
            ...
            : { classes: [t.closedClass], styles: Ms(t.dimension.property, '0px') }
        )
      },
      events: (e, t) =>
        Hr([
  ...
  const Q_ = Ol({
      ...
      x_(
        {
          ...
          fetch: (t, n) => {
            ...
            e.fetch(
              (t) => {
                n(C_(t, pv.CLOSE_ON_EXECUTE, o, { isHorizontalMenu: !1, search: e.search }))
              },
              s,
              eT(t)
            )
          ...
          n.setActive(s),
            ...
            o.shared.getSink().each((o) => {
              t()
                .getOpt(o)
                .each((t) => {
                  Dl(t.element), Ir(t, vk, { name: e.name, value: e.storage.get() })
                })
            })
        },
        s = (e) => (t) => {
    ...
    lT = ({
      ...
      components: e.map((e) =>
        'leaf' === e.type
          ? rT({ leaf: e, selectedId: r, onLeafAction: t, visible: o, treeId: n, backstage: a })
          : dT({
              directory: e,
              expandedIds: s,
              selectedId: r,
    ...
    dT = ({
      ...
      return {
        ...
        components: [
          iT({ directory: e, visible: o, noChildren: 0 === e.children.length, backstage: s }),
          lT({
            children: i,
            expandedIds: r,
            selectedId: a,
  ...
  var pT = Object.freeze({ __proto__: null, throttle: gT, init: (e) => e.stream.streams.state(e) }),
    hT = [
      ns(
        'stream',
        Jn('mode', {
  ...
  const fT = Ol({ fields: hT, name: 'streaming', active: mT, state: pT }),
    ...
    ST = x([
      Wu({
        ...
        overrides: (e) => ({
          ...
          onExecute: (t, o) => e.lazyTypeaheadComp.get().map((e) => (Ir(e, xT(), { item: o }), !0)),
          onHover: (t, o) => {
            e.previewing.set(!1),
              e.lazyTypeaheadComp.get().each((t) => {
    ...
    AT = (e, t, o, n = [], s = []) => {
      ...
      return _T(e, t, n, { tag: 'button', classes: c, attributes: { title: r } }, i, o)
    },
    MT = (e, t, o, n = [], s = []) => {
    ...
    RT = (e, t) => ({ type: 'menuitem', value: t, text: e, meta: { attach: void 0 }, onAction: b }),
    ...
    $T = {
              ...
              behaviours: kl([
                ...
                pu.config({
                  ...
                  onSetValue: (o, n) => {
                    ;((o, n) => {
                      ...
                      'auto' === e.columns &&
                        ix(o, 5, 'tox-collection__item').each(({ numRows: e, numColumns: t }) => {
                ...
                Pp.config(
                  ...
                  1 === c
                    ...
                    : {
                        mode: 'matrix',
                        selectors: { row: '.tox-collection__group', cell: `.${fv}` },
                      })
                ),
                ...
                components: e.url
                  ? [
                      Wh.sketch({
                        ...
                        action: (t) => Ir(t, vk, { name: 'alert-banner', value: e.url }),
      ...
      button: GT((e, t) =>
        ((e, t) => {
          ...
          return (
            (n = A.none()),
            (s = ak.parts.field({ factory: Wh, ...AT(e, A.some(o), t, [VO(''), DO()]) })),
            uk(n, s, [], [])
          )
          var n, s
        })(e, t.shared.providers)
                  ...
                  x_(
                    {
                      ...
                      fetch: (o, n) => {
                        ...
                        n(C_(s, pv.CLOSE_ON_EXECUTE, t, { isHorizontalMenu: !1, search: A.none() }))
                      },
                      onSetup: x(b),
                      getApi: x({}),
                      columns: 1,
                      ...
                      dropdownBehaviours: [
                        ...
                        RO(
                          ...
                          (t, o) => {
                            E_(e.items, o).each((e) => {
                              kt(t.element, __, e.value), Ir(t, v_, { text: e.text })
                            })
                          }
                        ),
                      ],
      ...
      sizeinput: GT((e, t) =>
        ((e, t) => {
          ...
          const n = la('ratio-event'),
            s = (e) =>
              tb(e, { tag: 'span', classes: ['tox-icon', 'tox-lock-icon__' + e] }, t.icons),
            r = F_.parts.lock({
              dom: {
                tag: 'button',
                      ...
                      R_(e, t.unit)
                        ...
                        .map((e) => {
                          return (
                            (o = e),
                            (n = t.unit),
                            (e) => R_(e, n).map((e) => ({ value: e * o, unit: n }))
                          )
                          var o, n
                        })
                        .getOr(N_)
                ...
                const s = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        ...
                        return 'file' === e
                          ? ((s = [n, PT(a, VT(t)), PT(a, q([HT(t), zT(t), LT(t)]))]),
                            j(
                              s,
                              (e, t) =>
                                0 === e.length || 0 === t.length ? e.concat(t) : e.concat(FT, t),
                              []
                            ))
                          : n
                        var s
                  ...
                  r = C_(s, pv.BUBBLE_TO_SANDBOX, t, { isHorizontalMenu: !1, search: A.none() })
                return bS(r)
              },
              ...
              Kr((s) => {
                o.getOpt(s).each((o) => {
                  ;(((e) => ve(e, 'init'))(e)
                    ...
                    : HO.load(e.scriptId, e.scriptUrl).then((t) => t(o.element.dom, e.settings))
                  ).then((e) => {
                    n.on((t) => {
                      e.setValue(t)
                    }),
      ...
      htmlpanel: GT((e) =>
        'presentation' === e.presets
          ? ok.sketch({ dom: { tag: 'div', classes: ['tox-form__group'], innerHtml: e.html } })
          : ok.sketch({
              dom: {
                tag: 'div',
              ...
              RO(
                ...
                (e, t) => {
                  ...
                  n.getOpt(e).each((o) => {
                    ...
                    var s
                    t.url !== Ot(n, 'src') &&
                      (kt(n, 'src', t.url), Pa(e.element, 'tox-imagepreview__loaded')),
                      a(),
                      ((s = n),
                      new Promise((e, t) => {
                        const o = () => {
            ...
            components: [
              ((s = e.header),
              {
                ...
                components: [
                  {
                    dom: { tag: 'tr' },
                    components: H(s, (e) => ({ dom: { tag: 'th', innerHtml: t.translate(e) } })),
                  },
                ],
              }),
              ((n = e.cells),
              {
                dom: { tag: 'tbody' },
                components: H(n, (e) => ({ dom: { tag: 'tr' }, components: H(e, o) })),
              }),
            ],
    ...
    rE = (e, t, o) =>
      zi(ZT(e), oE(e, t), o.insetSoutheast(), Ui(), 'southeast', Ki(e, { left: 1, bottom: 3 }), JT),
    aE = (e, t, o) =>
      zi(eE(e, t), tE(e), o.insetNorthwest(), Pi(), 'northwest', Ki(e, { right: 0, top: 2 }), JT),
    iE = (e, t, o) =>
      zi(ZT(e), tE(e), o.insetNortheast(), Li(), 'northeast', Ki(e, { left: 1, top: 2 }), JT),
    lE = (e, t, o) => zi(QT(e, t), tE(e), o.insetNorth(), ji(), 'north', Ki(e, { top: 2 }), JT),
    cE = (e, t, o) =>
      zi(QT(e, t), oE(e, t), o.insetSouth(), Gi(), 'south', Ki(e, { bottom: 3 }), JT),
    dE = (e, t, o) => zi(eE(e, t), nE(e, t), o.insetEast(), qi(), 'east', Ki(e, { right: 0 }), JT),
    uE = (e, t, o) => zi(ZT(e), nE(e, t), o.insetWest(), $i(), 'west', Ki(e, { left: 1 }), JT),
    mE = (e) => {
      switch (e) {
        case 'north':
          return lE
    ...
    xE = (e, t) => () => ({
      ...
      getSelection: () => {
        ...
        return A.some(
          Lc.range(Ve(t.startContainer), t.startOffset, Ve(t.endContainer), t.endOffset)
        )
      },
    }),
    ...
    VE = NE('true'),
    zE = NE('false'),
    HE = (e, t, o, n, s) => ({ type: e, title: t, url: o, level: n, attach: s }),
    ...
    eA = (e, t) => {
      ...
      ;(o[t] = [e].concat(s).slice(0, 5)),
        ((e) => {
          if (!JE(e)) throw new Error('Bad format for history:\n' + JSON.stringify(e))
    ...
    rA = (e) => ({
      ...
      getLinkInformation: () =>
        ((e) =>
          Vb(e)
            ? A.some({ targets: XE(e.getBody()), anchorTop: sA(zb(e)), anchorBottom: sA(Hb(e)) })
            : A.none())(e),
    ...
    cA = ju({ name: 'items', overrides: () => ({ behaviours: kl([Kp.config({})]) }) }),
    dA = x([cA]),
    uA = bm({
      name: x('CustomList')(),
      configFields: lA(),
    ...
    gA = x([ju({ name: 'groups', overrides: () => ({ behaviours: kl([Kp.config({})]) }) })]),
    pA = bm({
      name: 'Toolbar',
      configFields: mA(),
      partFields: gA(),
    ...
    bA = x([])
  var vA,
    yA = Object.freeze({ __proto__: null, setup: hA, isDocked: fA, getBehaviours: bA })
  const xA = (e) =>
    ...
    TA = (e, t, o) => ({ location: 'bottom', leftX: t, bottomY: e.bottom - o.bounds.bottom }),
    ...
    NA = (e, t, o, n, s = !1) => {
      t.contextual.each((t) => {
        t.lazyContext(e).each((r) => {
          ...
          a !== o.isVisible() &&
            (o.setVisible(a),
            s && !a ? (Wa(e.element, [t.fadeOutClass]), t.onHide(e)) : (a ? SA : kA)(e, t))
        })
      })
    },
    VA = (e, t, o, n, s) => {
  ...
  const $A = Ol({
    ...
    tM = (e, t) => {
      const o = Ql(),
        ...
        a = e.inline ? [] : [Al.config({ channels: { [qA()]: { onReceive: ZA } } })]
      return [
        oh.config({}),
        $A.config({
          contextual: {
  ...
  const cM = 'container',
    ...
    pM = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = []
            return { slot: (t, o) => (e.push(t), Ju(cM, uM(t), o)), record: x(e) }
          })(),
          o = e(t),
          n = t.record(),
    ...
    bM = (e, t) => {
      const o = H(ae(t), (e) => {
        ...
        return { name: e, getApi: fM, onSetup: n.onSetup, onShow: n.onShow, onHide: n.onHide }
      })
      return H(o, (t) => {
        const n = Es(b)
      ...
      wm
        ...
        .bind((e) =>
          Q_.isGrowing(e) || Q_.hasGrown(e)
            ? wm.getCurrent(e).bind((e) => G(pM.getSlotNames(e), (t) => pM.isShowing(e, t)))
            : A.none()
        ),
    wM = la('FixSizeEvent'),
    SM = la('AutoSizeEvent')
  var kM = Object.freeze({
      ...
      block: (e, t, o, n) => {
        ...
        const s = t.getRoot(e).getOr(e),
          r = kl([
            Pp.config({ mode: 'special', onTab: () => A.some(!0), onShiftTab: () => A.some(!0) }),
            oh.config({}),
          ]),
          a = n(s, r),
  ...
  const OM = Ol({
        ...
        s !== n.get() &&
          ...
          ((e, t, o, n) => {
            ...
            if (
              ...
              OM.unblock(t), Dt(s, 'display', 'none'), kt(s, 'aria-hidden', 'true'), o && e.focus()
            }
          })(e, t(), s, o.providers),
          ((e, t) => {
    ...
    BM = (e, t, o) => {
      ...
      0 === l.extra.length ? (Kp.remove(s, r), o([])) : (DM(s, l.within), o(l.extra)),
                      ...
                      behaviours: kl([
                        ...
                        Xd.config({
                          onOpen: (s, r) => {
                            ...
                            o.fetch().get((s) => {
                              UM(e, r, o, t.layouts, s), n.link(e.element), a || Pp.focusIn(r)
                            })
                          },
                          onClose: () => {
                            dh.off(e), HM.get().getOr(!1) || oh.focus(e), n.unlink(e.element)
                          },
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          behaviours: bu(e.splitToolbarBehaviours, [
            uS.config({
              others: {
                overflowGroup: () => $M.sketch({ ...n['overflow-group'](), items: [s.asSpec()] }),
              },
            }),
          ]),
          apis: {
      ...
      Uu({
        ...
        overrides: (e) => ({
          toolbarBehaviours: kl([
            ...
            Pp.config({
              mode: 'acyclic',
              onEscape: (t) => (om(t, e, 'overflow-button').each(oh.focus), A.some(!0)),
            }),
          ]),
        }),
      }),
    ...
    rD = (e) => {
      const t = sD(e),
        o = YM.parts.primary({ dom: { tag: 'div', classes: ['tox-toolbar__primary'] } })
      return YM.sketch({
        ...t,
        lazySink: e.getSink,
        getOverflowBounds: () => {
    ...
    aD = (e) => {
      const t = eD.parts.primary({ dom: { tag: 'div', classes: ['tox-toolbar__primary'] } }),
        o = eD.parts.overflow({ dom: { tag: 'div', classes: ['tox-toolbar__overflow'] } }),
        n = sD(e)
      return eD.sketch({
        ...n,
        components: [t, o],
        ...
        onOpened: (t) => {
          t.getSystem().broadcastOn([qA()], { type: 'opened' }), e.onToggled(t, !0)
        },
        onClosed: (t) => {
          t.getSystem().broadcastOn([qA()], { type: 'closed' }), e.onToggled(t, !1)
        },
      })
    },
    iD = (e) => {
            ...
            return {
              ...
              dom: {
                ...
                classes: [
                  ...
                  ...(hD || fD ? ['tox-view--mobile', 'tox-view--scrolling'] : []),
                ],
              },
              behaviours: kl([
                oh.config({}),
  ...
  const kD = iA.optional({ factory: lM, name: 'menubar', schema: [os('backstage')] }),
    CD = iA.optional({
      factory: {
        sketch: (e) =>
          uA.sketch({
    ...
    DD = iA.optional({ factory: SD, name: 'viewWrapper', schema: [os('backstage')] }),
    BD = iA.optional({
      factory: {
        sketch: (e) => ({
          uid: e.uid,
                ...
                wm.getCurrent(o).each((n) => {
                  Q_.hasGrown(o)
                    ? pM.isShowing(n, t)
                      ...
                      : (pM.hideAllSlots(n), pM.showSlot(n, t), yM(e.element, 'region'))
                    : (pM.hideAllSlots(n), pM.showSlot(n, t), Q_.grow(o), yM(e.element, 'region'))
                })
              })
            })(e, o)
          )
    ...
    jD = (e, t, o) => {
      ...
      return {
        ...
        getFetch: (e, t) => (o, n) => {
          const s = t(),
            a = r(s)
          n(C_(a, pv.CLOSE_ON_EXECUTE, e, { isHorizontalMenu: !1, search: A.none() }))
        },
      }
    },
    GD = (e, t, o) => {
  ...
  const XD = (e, t, o) => {
      const n =
        ((s = ((e, t) => (t === qD.SemiColon ? e.replace(/;$/, '').split(';') : e.split(' ')))(
          e.options.get(t),
          o
        )),
        H(s, (e) => {
    ...
    KD = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          G(YD, (e) => e.format === t.format).each((t) => e.execCommand(t.command)),
        updateText: (t) => {
          const o = G(YD, (t) => e.formatter.match(t.format)).fold(x('left'), (e) =>
            e.title.toLowerCase()
          )
    ...
    uB = (e, t) => {
      ...
      return {
        ...
        updateText: (t) => {
          const n = (e) =>
              EE(e) ? X(e.items, n) : AE(e) ? [{ title: e.title, format: e.format }] : [],
            s = X(BE(e), n),
        ...
        (e, t) =>
          ((e, t) => {
            const o = (e) => ({
                ...
                isActive: () =>
                  pi(e.element, 'span').exists((t) => e.getSystem().getByDom(t).exists(dh.isOn)),
                setText: (t) =>
                  pi(e.element, 'span').each((o) =>
                    e
                      .getSystem()
            ...
            return fB.sketch({
              dom: {
                ...
                attributes: { 'aria-pressed': !1, ...yB(e.tooltip, t.providers) },
              },
              onExecute: (t) => {
                const n = o(t)
        ...
        (e, t, o) => {
          ...
          if (Cb(o) === sb.floating)
            return ((e, t, o, n) => {
              const s = t.shared,
                r = Es(b),
                a = { toolbarButtonBehaviours: [], getApi: bB, onSetup: e.onSetup },
              ...
              e,
              t,
              (e) => MB(o, { buttons: n, toolbar: e, allowToolbarGroups: !1 }, t, A.none()),
              s
            )
              ...
              return Wh.sketch({
                ...
                buttonBehaviours: kl([
                  ...
                  Jp(c, [
                    ...
                    Ex({ getApi: r }, a),
                    Ur(Ks(), (e, t) => {
                      ;(t.event.raw.keyCode !== rB.space() && t.event.raw.keyCode !== rB.enter()) ||
                        Rm.isDisabled(e) ||
                        o(!1)
                    }),
                    Ur(er(), u),
            ...
            f = Gh({
              ...
              components: [
                Vv.sketch({
                  inputBehaviours: kl([
                    Rm.config({}),
                    Jp(i, [Tx({ onSetup: s, getApi: r }, a), Ex({ getApi: r }, a)]),
    ...
    render: (e, t, o, n, s) => {
        ...
        e.addCommand('ToggleView', (t, o) => {
          if (FD.toggleView(l, o)) {
            ...
            r.mothership.broadcastOn([Yd()], { target: t }),
              ...
              c(FD.whichView(l)) && (e.focus(), e.nodeChanged(), FD.refreshToolbar(l))
          }
        }),
      ...
      ;(g !== sb.sliding && g !== sb.floating) ||
        e.on('ResizeWindow ResizeEditor ResizeContent', () => {
          ...
          o !== i.get() && (FD.refreshToolbar(t.mainUi.outerContainer), i.set(o))
        })
      const p = {
        setEnabled: (e) => {
          xx(t, !e)
  ...
  const RB = (e) => (/^[0-9\.]+(|px)$/i.test('' + e) ? A.some(parseInt('' + e, 10)) : A.none()),
    ...
    PB = (e, t, o, n, s) => {
      const { mainUi: r, uiMotherships: a } = o,
        ...
        b = (e) =>
          p
            ? e.fold(x(0), (e) => (e.components().length > 1 ? Wt(e.components()[1].element) : 0))
            : 0,
        v = () => {
          L(a, (e) => {
            e.broadcastOn([Kd()], {})
        ...
        y = (o) => {
          ...
          const n = l
            ...
            : (() => {
                if (l) return A.none()
                if (
                  Xt(r.outerContainer.element).left + Zt(r.outerContainer.element) >=
              ...
              ((o) => {
                s.on((n) => {
                  const s = FD.getToolbar(r.outerContainer),
                    a = b(s),
                    i = Jo(t),
                    { top: l, left: c } = ((e, t) => (lv(e) ? xA(t) : A.none()))(
                      e,
  ...
  var WB = Object.freeze({
    ...
    render: (e, t, o, n, s) => {
      ...
      const d = () => {
        ...
        const s = rv(e)
        lv(e) ? (Rd(i, r.mothership), Rd(i, t.popupUi.mothership)) : Id(s, r.mothership),
            ...
            const s = Es(UB(t, o.isPositionedAtTop())),
              r = (n) => {
                ...
                s.set({ pos: r, bounds: a }),
                  c && gw(e, n),
                  o.isVisible() &&
                    (i !== r ? o.update($A.reset) : c && (o.updateMode(), o.repositionPopups()))
              }
  ...
  const jB = 'contexttoolbar-hide',
                ...
                Jp('context-toolbar-events', [
                  ...
                  Ur(nF, (e, o) => {
                    Ph.getContent(e).each((o) => {
                      ...
                      Ir(e, rF, { contents: o.event.forwardContents, focus: A.none() })
                  }),
                  Ur(sF, (e, o) => {
                    ne(t.get()).each((o) => {
              ...
              const s = 'node' === t ? r.anchors.node(n) : r.anchors.cursor(),
                c = ((e, t, o, n) =>
                  'line' === t
                    ...
                    : { bubble: gc(0, 12, KB, 1 / 12), layouts: eF(e, o, n, t), overrides: JB })(
                  e,
                  t,
                  a(),
                  {
                      ...
                      ((e, t, o) =>
                        e(t)
                          ...
                          : Fs(
                              ...
                              (e) => {
                                if (Ge(e)) {
                                  const { contextToolbars: t, contextForms: n } = tF(
                                      e,
                                      o.inNodeScope
                                    ),
                                    s =
    ...
    dF = (e) => {
      cF(
        ...
        ((e) => ({
          ...
          getOptions: Zb,
          hash: (e) =>
            ((e, t) => sB(e, ['fixed', 'relative', 'empty']).map(({ value: e, unit: t }) => e + t))(
              e
            ).getOr(e),
          display: w,
    ...
    mF = (e, t) => (o) => {
      ...
      return e.on('PastePlainTextToggle', n), fw(() => e.off('PastePlainTextToggle', n), bw(e)(o))
    },
    gF = (e, t) => () => {
    ...
    EF = (e, t, o, n, s, r) => {
      const a = o(),
        i = TF(e, t, r)
      C_(a, pv.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !1, search: A.none() }).map((e) => {
        t.preventDefault(),
          Ph.showMenuAt(s, { anchor: i }, { menu: { markers: Av('normal') }, data: e })
      })
    },
    AF = {
      ...
      const a = Do(),
        ...
        u = () => {
          ...
          ;((e, t, o, n, s, r, a) => {
            ...
            C_(o, pv.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !0, search: A.none() }).map((o) => {
              t.preventDefault()
    ...
    HF = As([{ offset: ['x', 'y'] }, { absolute: ['x', 'y'] }, { fixed: ['x', 'y'] }]),
    ...
    QF = (e, t, o, n) =>
      re(e, (e) => {
        ...
        return r ? A.some({ output: qF(e.output, t, o, n), extra: e.extra }) : A.none()
      }),
    eI = (e, t, o, n, s) => {
      ...
      return QF(r, o, n, s).orThunk(() => {
        ...
        return e.snap.map((e) => ({ output: qF(e.output, o, n, s), extra: e.extra }))
      })
    },
    tI = (e, t, o, n, s) => {
      const r = t.getSnapPoints(e)
    ...
    snapTo: (e, t, o, n) => {
      ...
      if (t.repositionTarget) {
        const t = et(e.element),
          o = Uo(t),
          r = wA(s),
          a = ((e, t, o) => ({ coord: qF(e.output, e.output, t, o), extra: e.extra }))(n, o, r),
          i = $F(a.coord, 0, r)
        Ft(s, i)
      }
    },
  ...
  const lI = [
    ...
    cI = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) => ('fixed' === o ? KF : XF)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie()
            )
    ...
    dI = (e, t) => ({ bounds: e.getBounds(), height: jt(t.element), width: Zt(t.element) }),
    uI = (e, t, o, n, s) => {
  ...
  const vI = (e, t, o) => {
    ...
    wI = [...lI, Ri('dragger', { handlers: gI((e, t, o) => [...hI(e, t, o), ...vI(e, t, o)]) })]
  var SI = Object.freeze({ __proto__: null, mouse: yI, touch: xI, mouseOrTouch: wI }),
    kI = Object.freeze({
      __proto__: null,
      init: () => {
        let e = A.none(),
    ...
    TI = (e) =>
      Gh(
        Wh.sketch({
          ...
          buttonBehaviours: kl([
            CI.config({ mode: 'mouseOrTouch', blockerClass: 'blocker', snaps: e }),
            Ik.config({}),
          ]),
          eventOrder: {
  ...
  const DI = (e, t, o) => {
      ...
      const o = e.inline,
        ...
        y = ((e, t, o, n) => {
          const s = Es(!1),
            ...
            u = {
              shared: { providers: a, anchors: SE(t, o, n, r.isPositionedAtTop), header: r },
              urlinput: i,
              styles: l,
              colorinput: c,
              dialog: d,
            ...
            m = {
              ...u,
              shared: { ...u.shared, interpreter: (e) => KT(e, {}, m), getSink: e.popup },
            },
            g = {
              ...u,
              shared: { ...u.shared, interpreter: (e) => KT(e, {}, g), getSink: e.dialog },
            }
        ...
        x = () => {
          const t = (() => {
              const t = { attributes: { [yc]: d ? vc.BottomToTop : vc.TopToBottom } },
                ...
                i = Kb(e),
                l = qb(e),
                c = FD.parts.promotion({ dom: { tag: 'div', classes: ['tox-promotion'] } }),
                g = r || a || i,
                h = l ? [c, o] : [o]
            ...
            n = {
              ...
              components: [
                FD.parts.socket({ dom: { tag: 'div', classes: ['tox-edit-area'] } }),
                FD.parts.sidebar({ dom: { tag: 'div', classes: ['tox-sidebar'] } }),
              ],
            },
            s = FD.parts.throbber({
    ...
    qI = Jn('type', { submit: jI, cancel: jI, custom: jI, menu: GI, togglebutton: $I }),
    ...
    gR = Gn((e) =>
      qn('customeditor.old', Mn(mR), e).orThunk(() => qn('customeditor.new', Mn(uR), e))
    ),
    pR = Hn,
    hR = Dn(QI),
    fR = Bn(On),
  ...
  const _N = Ol({
    ...
    EN = (e, t, o) => {
      ...
      return {
        ...
        behaviours: kl([
          ...
          IO(n, { postprocess: (e) => TN(e).fold((e) => (console.error(e), {}), w) }),
          Jp('dialog-body-panel', [
            Ur(Xs(), (e, t) => {
              e.getSystem().broadcastOn([e_], { newFocus: A.some(t.event.target) })
            }),
          ]),
        ]),
      }
    ...
    GN = (e, t, o) => {
      ...
      return HN.sketch({
        ...
        components: [
          ...
          HN.parts.tabview({ dom: { tag: 'div', classes: ['tox-dialog__body-content'] } }),
        ],
    ...
    ZN = (e) =>
      HI.parts.footer({ dom: { tag: 'div', classes: ['tox-dialog__footer'] }, components: e }),
    QN = (e, t) => [
      ok.sketch({ dom: { tag: 'div', classes: ['tox-dialog__footer-start'] }, components: e }),
      ok.sketch({ dom: { tag: 'div', classes: ['tox-dialog__footer-end'] }, components: t }),
    ],
    eV = (e) => {
      const t = 'tox-dialog',
        o = t + '-wrap',
    ...
    tV = (e) =>
      Wh.sketch({
        ...
        buttonBehaviours: kl([ck.config({})]),
        components: [tb('close', { tag: 'span', classes: ['tox-icon'] }, e.icons)],
        action: (e) => {
          Fr(e, bk)
        },
      }),
    ...
    sV = (e, t, o) =>
      ((e, t, o) => {
        ...
        return ok.sketch({ dom: jh('<div class="tox-dialog__header"></div>'), components: a })
      })(
          ...
          redial: (r) => {
            n((n) => {
              ...
              n.getSystem().broadcastOn([`${YO}-${a}`], i),
                ...
                n.getSystem().broadcastOn([`${ZO}-${a}`], { ...i.internalDialog, buttons: l }),
    ...
    bV = (e, t, o, n = !1) => {
      const s = la('dialog'),
        ...
        u = lV(i.buttons),
        m = cV(u),
        g = Ce(0 !== u.length, Gh(((e, t, o) => gV(e, t, o))({ buttons: u }, s, o))),
        p = uV(
          () => b,
          {
            onBlock: (e) => {
        ...
        f = ri({
          ...
          behaviours: kl([
            Pp.config({
              ...
              useTabstopAt: (e) =>
                !XO(e) && ('button' !== Ue(e) || 'disabled' !== Ot(e, 'disabled')),
              firstTabstop: 1,
            }),
            _N.config({ channel: `${YO}-${s}`, updateState: (e, t) => A.some(t), initialData: e }),
            oh.config({}),
            Jp(
              'execute-on-form',
              p.concat([
      ...
      const s = la('dialog'),
        ...
        l = ((e) => {
          const t = {
            ...
            behaviours: kl([Pp.config({ mode: 'acyclic', useTabstopAt: C(XO) })]),
          }
  ...
  tn.add('silver', (e) => {
    ...
    let t = () => en()
    const { dialogs: o, popups: n, renderUI: s } = RI(e, { getPopupSinkBounds: () => t() })
