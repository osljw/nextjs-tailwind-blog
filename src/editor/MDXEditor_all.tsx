...
export default function Playground({ initialValue }) {
      ...
      <div className="playground">
          ...
          <div className="playground-area">
            <div className="playground-inner">
              <div className="playground-draw">
                {starryNight && toJsxRuntime(starryNight.highlight(value, scope), runtime)}
        ...
        Add a `br` to make the last newline explicit. */}
              ...
              <textarea
                ...
                // className={styles.styles['playground-write']}
                value={value}
                rows={value.split('\n').length + 1}
          ...
          <div className="playground-controls">
            ...
            <fieldset disabled={show === 'result'}>
              ...
              <label>
                ...
                />{' '}
                function body (<code>outputFormat: &apos;function-body&apos;</code>)
              </label>
              <label>
                <input
                  type="radio"
